...
$(document).ready(function (){
    categorias = $('#categorias').DataTable({ 
        "processing": true,
        "serverSide": true,
        "order": [],

        "ajax":{
            "url": "http://localhost/parque/index.php/categoria/list_categorias",
            "type": "POST"
        },
...
function delete_categoria(id_cat){  
    swal({
        title: "Advertencia",
        text: "¿Deseas eliminar este categoria?",
        type: "warning",
        ...
        $.ajax({
            url : "http://localhost/parque/index.php/categoria/delete_categoria/" + id_cat,
            type: "POST",
            dataType: "JSON",
            success: function (data){
                $('#categoria-modal').modal('hide');
        ...
        swal("Éxito", "¡La categoria fue eliminada!", "success");
    }, function (dismiss){
