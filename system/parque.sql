...
--
-- Host: localhost
-- Generation Time: Jan 07, 2018 at 12:08 AM
...
(220, 'Usuario', 'Ha ingresado al sistema.', 1, '2018-01-06 20:00:38'),
(221, 'Censo', 'Se ha registrado el censo número 1.', 1, '2018-01-06 20:03:05'),
(222, 'Censo', 'Se ha actualizado el estado del censo número 1.', 1, '2018-01-06 20:10:44'),
(223, 'Censo', 'Se ha finalizado el censo número 1.', 1, '2018-01-06 20:27:21'),
(224, 'Usuario', 'Ha ingresado al sistema.', 1, '2018-01-06 20:33:50'),
(225, 'Censo', 'Se ha registrado el censo número 2.', 1, '2018-01-06 22:33:57'),
(226, 'Censo', 'Se ha actualizado el estado del censo número 2.', 1, '2018-01-06 22:36:07'),
(227, 'Usuario', 'Ha ingresado al sistema.', 1, '2018-01-06 22:39:06'),
(228, 'Censo', 'Se ha actualizado el estado del censo número 2.', 1, '2018-01-06 22:40:49'),
(229, 'Censo', 'Se ha actualizado el estado del censo número 2.', 1, '2018-01-06 22:41:33'),
(230, 'Censo', 'Se ha registrado el censo número 3.', 1, '2018-01-06 22:56:44'),
(231, 'Usuario', 'Ha ingresado al sistema.', 1, '2018-01-06 23:20:23'),
(232, 'donacion', 'Se ha registrado un donacion.', 1, '2018-01-06 23:25:42'),
(233, 'mantenimiento', 'Se ha registrado un mantenimiento.', 1, '2018-01-06 23:36:35'),
(234, 'mantenimiento', 'Se ha actualizado el estado del mantenimiento 1.', 1, '2018-01-06 23:37:35'),
(235, 'mantenimiento', 'Se ha finalizado el mantenimiento número 1.', 1, '2018-01-06 23:42:21'),
(236, 'reforestacion', 'Se ha registrado el reforestacion número 1.', 1, '2018-01-06 23:47:49'),
(237, 'reforestacion', 'Se ha actualizado el estado del reforestacion número 1.', 1, '2018-01-06 23:48:24'),
(238, 'reforestacion', 'Se ha finalizado el reforestacion número 1.', 1, '2018-01-06 23:48:55'),
(239, 'servicio', 'Se ha registrado un servicio.', 1, '2018-01-06 23:57:15'),
(240, 'servicio', 'Se ha actualizado el estado del servicio 1.', 1, '2018-01-06 23:57:20'),
(241, 'servicio', 'Se ha finalizado el servicio número 1.', 1, '2018-01-06 23:57:42'),
(242, 'Usuario', 'Ha salido del sistema.', 1, '2018-01-07 00:07:51');
...
('be104t8bkic28qbqs1122v2p8v42v0g8', '::1', 1515283671, 0x5f5f63695f6c6173745f726567656e65726174657c693a313531353238333637313b746f6b656e7c733a34303a2266663462353561646336363262353162333738316437646537333966396237303062353836353530223b);
...
(1, 'AA03', 'Apamate', 'Tebebuia Rosea', 'Bignoniaceae', 'Flora', 50, 10, 0, 'Activa'),
...
(8, 'AB01', 'Guayaba', 'Psidium Guajava', 'Myrtaceae', 'Flora', 3, 10, 0, 'Activa'),
(9, 'AB02', 'Mango', 'Mangifera Indica', 'Sapindaceae', 'Flora', 3, 5, 0, 'Activa'),
(10, 'AB03', 'Uvero', 'Coccoloba caracasana', 'Polygonaceae', 'Flora', 33, 5, 0, 'Activa');
...
--
ALTER TABLE `bitacoras`
  MODIFY `id_bit` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=243;
--
-- AUTO_INCREMENT for table `cabanas`
--
ALTER TABLE `cabanas`
  MODIFY `id_cab` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
