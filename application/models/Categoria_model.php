...
class Categoria_model extends CI_Model {
	...
	var $column_order = array('categoria','descripcion',null);
	var $column_search = array('categoria','descripcion');
	var $order = array('id_cat' => 'asc');
	...
	public function get_by_id($id_cat)
	{
	...
	public function validate_by_nombre($categoria)
	{
		$this->db->from($this->table);
	...
	public function activate_by_id($id_cat)
	{
	...
	public function desactivate_by_id($id_cat)
	{
