        ...
        <div class="page-content-wrapper">
            ...
            <div class="page-content">
                ...
                <div class="page-head">
                    ...
                    <div class="page-toolbar">
                        ...
                        <div class="btn-group btn-theme-panel animated fadeInRight">
                            <a href="<? echo site_url('mantenimiento/new'); ?>" class="btn dropdown-toggle">
                                <i class="icon-plus"></i>
                            </a>
                        </div>
                        <!-- END THEME PANEL -->
                ...
                <ul class="page-breadcrumb breadcrumb animated fadeInLeft">
                    ...
                    <li>
                        <span class="active">Mantenimientos</span>
                    </li>
                </ul>
                <!-- END PAGE BREADCRUMB -->
                        ...
                        <div class="portlet light bordered animated fadeIn">
                            <div class="portlet-title">
                                <div class="caption font-dark">
                                    ...
                                    <span class="caption-subject bold uppercase">Listado de Mantenimientos</span>
                                </div>
                                <div class="tools"> </div>
                            </div>
                            <div class="tabbable-line tabbable-full-width">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="tab_1_1">
                                        <div class="row">
                                            <div class="col-xs-12">
                                                <table id="mantenimientos_pendientes" class="table table-hover table-bordered small">
                                                    <thead>
                                                        <tr>
                                                            <th>#</th>
                                                            <th>Número</th>
                                    ...
                                    <div class="tab-pane" id="tab_1_2">
                                        <div class="row">
                                            <div class="col-xs-12">
                                                <table id="mantenimientos_en_progresos" class="table table-hover table-bordered small">
                                                    <thead>
                                                        <tr>
                                                            <th>#</th>
                                                            <th>Número</th>
                                    ...
                                    <div class="tab-pane" id="tab_1_3">
                                        <div class="row">
                                            <div class="col-xs-12">
                                                <table id="mantenimientos_finalizados" class="table table-hover table-bordered small">
                                                    <thead>
                                                        <tr>
                                                            <th>#</th>
                                                            <th>Número</th>
