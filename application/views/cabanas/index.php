        ...
        <div class="page-content-wrapper">
            ...
            <div class="page-content">
                ...
                <div class="page-head">
                    ...
                    <div class="page-toolbar animated fadeInRight">
                        ...
                        <div class="btn-group btn-theme-panel">
                            <a href="#" onclick="add_cabana()" class="btn" title="Agregar">
                                <i class="icon-plus"></i>
                            </a>
                        </div>
                        <!-- END THEME PANEL -->
                ...
                <ul class="page-breadcrumb breadcrumb animated fadeInLeft">
                    ...
                    <li>
                        <span class="active">Cabañas</span>
                    </li>
                </ul>
                <!-- END PAGE BREADCRUMB -->
                ...
                <div class="modal fade" id="cabana-modal" role="dialog" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <button type="button" id="btnSave_cab" onclick="save_cabana()" class="btn green-turquoise">Guardar</button>
