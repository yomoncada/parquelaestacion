                            ...
                            <div class="tabbable-line tabbable-full-width">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="tab_1_1">
                                        <div class="row">
                                            <div class="col-xs-12">
                                                <table id="censos_pendientes" class="table table-hover table-bordered small">
                                                    <thead>
                                                        <tr>
                                                            <th>#</th>
                                                            <th>Número</th>
                                    ...
                                    <div class="tab-pane" id="tab_1_2">
                                        <div class="row">
                                            <div class="col-xs-12">
                                                <table id="censos_en_progresos" class="table table-hover table-bordered small">
                                                    <thead>
                                                        <tr>
                                                            <th>#</th>
                                                            <th>Número</th>
                                    ...
                                    <div class="tab-pane" id="tab_1_3">
                                        <div class="row">
                                            <div class="col-xs-12">
                                                <table id="censos_finalizados" class="table table-hover table-bordered small">
                                                    <thead>
                                                        <tr>
                                                            <th>#</th>
                                                            <th>Número</th>
