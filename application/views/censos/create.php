    ...
    <body>
        <div class="page-content-wrapper">
            <div class="page-content">
                    ...
                    <div class="row invoice-head">
                        <div class="col-sm-6 col-xs-12">
                            <div class="invoice-logo">
                                <h1 class="uppercase">N° <?echo $total_cen+1;?></h1>
                            </div>
                        </div>
                        <div class="col-sm-6 col-xs-12">
                            <div class="row">
                ...
                <div class="modal2 fade" id="actividad-modal2" role="dialog" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"></button>
                                <div class="caption font-dark">
                                    <i id="icon" class="icon-plus font-dark"></i>
                                    <span class="caption-subject bold uppercase actividad-modal-title2">Título</span>
                                </div>
                            </div>
                            <div class="modal-body">
                                <form action="#" id="actividad_form2">
                                    <input type="hidden" value="" name="id_act" autocomplete="off"/>
                                    <div class="form-group">
                                        <span class="required"> * (Campos Requeridos) </span>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="select_empleados_asignados" name="empleado">
                            ...
                            <div class="modal-footer">
                                <button type="button" onclick="assign_actividad()" class="btn green-turquoise">Guardar</button>
                                <button type="button" class="btn btn-default" data-dismiss="modal">Cancelar</button>
                            </div>
                        </div>
                    </div>
