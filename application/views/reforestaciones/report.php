...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Reporte del Reforestación N° <?echo $reforestacion['id_ref'];?></title>
                        ...
                        <div class="col-xs-6">
                            <div class="row">
                                <div class="col-xs-6 col-xs-offset-6 text-right" style="margin-top: 1.5em;">
                                    <h3><span class="bold uppercase">reforestacion Nº <?echo $reforestacion['id_ref'];?></span></h3>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xs-12">
                    ...
                    <div class="row" style="padding-top: 1.5em; padding-bottom: 2.5em">
                        <div class="col-xs-12">
                            <div class="col-xs-6 text-center">
                                ...
                                <br>
                                <span class="bold"><?echo $reforestacion['usuario'];?></span>
                                <br>
                                <span class="bold">Reforecista</span>
                            </div>
                            <div class="col-xs-6 text-center">
                    ...
                    <div class="row" style="padding-top: 1.5em; padding-bottom: 2.5em">
                        <div class="col-xs-12">
                            ...
                            <br>
                            <?if($reforestacion['observacion']){?>
                            <span class="text-left"><?echo $reforestacion['observacion'];?></span>
                            <?}else{?>
