        ...
        <div class="page-content-wrapper">
            ...
            <div class="page-content">
                ...
                <div class="page-head">
                    ...
                    <div class="page-toolbar">
                        ...
                        <div class="btn-group btn-theme-panel animated fadeInRight">
                            <a href="<? echo site_url('reforestacion/new'); ?>" class="btn dropdown-toggle">
                                <i class="icon-plus"></i>
                            </a>
                        </div>
                        <!-- END THEME PANEL -->
                ...
                <ul class="page-breadcrumb breadcrumb animated fadeInLeft">
                    ...
                    <li>
                        <span class="active">Reforestaciones</span>
                    </li>
                </ul>
                <!-- END PAGE BREADCRUMB -->
                        ...
                        <div class="portlet light bordered animated fadeIn">
                            <div class="portlet-title">
                                <div class="caption font-dark">
                                    ...
                                    <span class="caption-subject bold uppercase">Listado de Reforestaciones</span>
                                </div>
                                <div class="tools"> </div>
                            </div>
