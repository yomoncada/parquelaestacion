        ...
        <div class="page-content-wrapper">
            ...
            <div class="page-content">
                ...
                <div class="page-head">
                    ...
                    <div class="page-toolbar animated fadeInRight">
                        ...
                        <div class="btn-group btn-theme-panel">
                            <a href="#" onclick="add_edificio()" class="btn" title="Agregar">
                                <i class="icon-plus"></i>
                            </a>
                        </div>
                        <!-- END THEME PANEL -->
                ...
                <ul class="page-breadcrumb breadcrumb animated fadeInLeft">
                    ...
                    <li>
                        <span class="active">Edificios</span>
                    </li>
                </ul>
                <!-- END PAGE BREADCRUMB -->
                ...
                <div class="modal fade" id="edificio-modal" role="dialog" aria-hidden="true">
